CREATE DATABASE  IF NOT EXISTS `PV` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `PV`;
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: PV
-- ------------------------------------------------------
...
CREATE TABLE `almacen` (
  ...
  `estado` enum('Disponible','Dañado','Caducado') DEFAULT 'Disponible',
...
CREATE TABLE `perdidas` (
  ...
  CONSTRAINT `perdidas_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`),
  CONSTRAINT `perdidas_ibfk_2` FOREIGN KEY (`id_motivo`) REFERENCES `motivos` (`id_motivo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'PV'
--

--
-- Dumping routines for database 'PV'
--
...
-- Dump completed on 2025-02-05 12:32:29
