...
menuButton.addEventListener("click", () => {
    ...
    menuButton.style.display = 'none'; // Ocultar el botón de tres puntos
});

// Cerrar el menú
closeSidebar.addEventListener("click", () => {
    sidebar.style.transform = "translateX(100%)"; // Oculta el menú
    menuButton.style.display = 'block'; // Mostrar el botón de tres puntos
});

/* Para la carga dinámica del contenido */
